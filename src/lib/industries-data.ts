...
export const INDUSTRY_DATA: Record<string, Industry> = {
  'home-services': {
    ...
    metaDescription: 'For plumbers, electricians and builders. AI ads bring leads in and the AI Sales Agent books them in seconds, day or night. From $197/mo.',
  ...
  'health-wellness': {
    ...
    metaDescription: 'For physios, gyms and med spas. AI ads plus a 24/7 AI Sales Agent that qualifies, books and reactivates lapsed clients. From $197/mo.',
  ...
  'professional-services': {
    ...
    metaTitle: 'AI Marketing for Professional Services | LazyMagnet',
    metaDescription: 'For accountants, lawyers and consultants. Win high-value clients with fast, professional lead handling: AI ads plus a 24/7 AI Sales Agent. From $197/mo.',
  ...
  'ecommerce': {
    ...
    metaDescription: 'For online stores and retail. AI ads that create, test and optimise across Google, Facebook and Instagram on real sales, not clicks. From $197/mo.',
  ...
  'franchise': {
    ...
    metaTitle: 'AI Marketing for Franchises & Multi-Location | LazyMagnet',
    metaDescription: 'For franchises and multi-location groups. Fast, consistent lead response everywhere, templated local ads and network-wide reactivation. From $197/mo.',
